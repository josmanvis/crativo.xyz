...
export default function ContactInfo({ info }: ContactInfoProps) {
  return (
    <div className="mb-16">
      ...
      {/* Email */}
      <div className="mb-8">
        <h3 className="text-sm font-semibold text-neutral-400 mb-2">Email</h3>
        <a
      ...
      {/* Social Links */}
      <div>
        <h3 className="text-sm font-semibold text-neutral-400 mb-3">Social</h3>
        <div className="flex gap-4">
          {info.socialLinks.map((link) => (
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 bg-neutral-800 rounded-lg text-neutral-200 hover:bg-neutral-700 hover:text-white transition-colors"
